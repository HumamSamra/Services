  ...
  function LoadItems(){
    ...
    for(let i = 1; i < 10000; i++){
        ...
        if(!f){
            ...
            +'</div><div class="d-flex gap-2 w-100 justify-content-between"><div class="w-100"><input class="mb-0 form-control" oninput="Update(' + i.toString() + ')" id="term_' + i.toString() + '" value="' + val[0] + '">'
